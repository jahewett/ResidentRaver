    ...
    .defines(function() {
        EntityPlayer = ig.Entity.extend( {
            ...
            kill: function() {
                ...
                if(ig.game.checkpointReached)
                {
                    // Checkpoint passed, respawn at checkpoint
                    ig.game.respawnPosition = {x:ig.game.checkpointPosition.x, y:ig.game.checkpointPosition.y};
                }
                else
                {
                    // Checkpoint not passed, respawn at start
        ...
        EntityBullet = ig.Entity.extend ({
            ...
            init: function(x, y, settings) {
                var posX = x + (settings.flip ? -4 : 8);

                this.parent(posX, y+8, settings);
        ...
        EntityGrenade = ig.Entity.extend ({
            ...
            kill: function() {
                for(var i = 0; i < 20; i++)
                    ig.game.spawnEntity(EntityGrenadeParticle, this.pos.x, this.pos.y); this.parent();
            }
        });
