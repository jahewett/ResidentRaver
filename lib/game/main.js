ig.module (
    ...
    MyGame = ig.Game.extend({
        ...
        hudText: new ig.Font('media/04b03.font.png'),
        lives:3,
        ...
        update: function () {
            ...
            if(ig.input.pressed('volUp') && ig.music.volume < 1)
            {
                ig.music.volume += 0.1;
            }

            if(ig.input.pressed('volDown') && ig.music.volume > 0)
            {
                ig.music.volume -= 0.1;
            }
        },
        ...
        draw: function () {
            ...
            // Heads Up Display
            this.hudText.draw("Lives:", 5, 5);
            for(var i=0; i < this.lives; i++)
            {
                this.lifeSprite.draw(((this.lifeSprite.width + 2) * i) + 30, 3);
            }
            this.hudText.draw("Current Weapon: " + this.currentWeapon, 5, 15);
            this.hudText.draw("Current Level: " + this.currentLevel, 5, 25);
            this.hudText.draw("Time: " + Math.round(this.levelTimer.delta()), 5, 35);
        },
    ...
    StartScreen = ig.Game.extend({
        ...
        init: function() {
            ...
            if(soundFXOn)
            {
                this.soundFxStatus = "SoundFx: On";
            }
            else
            {
                this.soundFxStatus = "SoundFx: Off";
            }
            ...
            ig.input.bind(ig.KEY.Q, 'volUp');
            ig.input.bind(ig.KEY.A, 'volDown');
        },
        ...
        draw: function() {
            ...
            this.instructText.draw(this.soundFxStatus, (ig.system.width/4) - 50, (ig.system.height - 225), ig.Font.ALIGN.CENTER);
